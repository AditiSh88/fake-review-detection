...
if st.button("Analyze"):
    ...
    # ---------------- LOGISTIC REGRESSION (FIXED) ----------------
        ...
        col1, col2 = st.columns(2)
        col1.markdown(f"<div style='background:#dbeafe;padding:10px;border-radius:8px'><b>Prediction</b><br>{prob_lr:.3f}</div>", unsafe_allow_html=True)
        col2.markdown(f"<div style='background:#ede9fe;padding:10px;border-radius:8px'><b>Confidence</b><br>{(1-abs(0.5-prob_lr)*2)*100:.2f}%</div>", unsafe_allow_html=True)
    ...
    # ---------------- XGBOOST (FIXED) ----------------
        ...
        col1, col2 = st.columns(2)
        col1.markdown(f"<div style='background:#dbeafe;padding:10px;border-radius:8px'><b>Prediction</b><br>{prob_xgb:.3f}</div>", unsafe_allow_html=True)
        col2.markdown(f"<div style='background:#ede9fe;padding:10px;border-radius:8px'><b>Confidence</b><br>{(1-abs(0.5-prob_xgb)*2)*100:.2f}%</div>", unsafe_allow_html=True)
